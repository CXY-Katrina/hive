...
def main():
    ...
    parser.add_argument("--source-commit", type=validate_sha, default="d4d2957e5208c2f464d4625c05920bd29ea233cb")
    ...
    if git_head(source) != args.source_commit:
        parser.error("--source-commit does not match the upstream checkout HEAD")
